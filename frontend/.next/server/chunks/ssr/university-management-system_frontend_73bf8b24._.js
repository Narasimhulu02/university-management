...
function ClassroomsPage() {
    ...
    const fetchClassrooms = async ()=>{
        try {
            ...
            if (!response.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$university$2d$management$2d$system$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to load classrooms");
                return;
            }
    ...
    const handleAdd = async (e)=>{
        ...
        try {
            ...
            if (response.ok) {
                ...
                const data = await response.json();
                __TURBOPACK__imported__module__$5b$project$5d2f$university$2d$management$2d$system$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(data.error || "Failed to add classroom");
            }
        } catch (error) {
    ...
    const confirmDelete = async ()=>{
        ...
        try {
            ...
            if (response.ok) {
                ...
                const data = await response.json();
                __TURBOPACK__imported__module__$5b$project$5d2f$university$2d$management$2d$system$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(data.error || "Failed to delete classroom");
            }
        } catch (error) {
...
//# sourceMappingURL=university-management-system_frontend_73bf8b24._.js.map